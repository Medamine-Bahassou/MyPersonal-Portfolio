...
const Certification = ({image, title, text, icons}) => {
  return (
        ...
        <>
        <div className='grid  md:grid-cols-3 md:grid-rows-1 grid-rows-1 gap-4 md:w-full border border-base-200 transition card p-4 hover:border-base-300 hover:cursor-pointer'>
